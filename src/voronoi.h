...
class VoronoiSweeper
{
    public:
        ...
        VoronoiSweeper(std::vector<VoronoiSite>* sites, unsigned int gen, uint8_t threadId);
        ~VoronoiSweeper();
    ...
    private:
        ...
        inline void addCircleEvent(SkipNode<O>* node, double lp, double sp, const glm::dvec3 & cc);
    ...
    public:
        static glm::dvec3 circumcenter(const glm::dvec3 & i, const glm::dvec3 & j, const glm::dvec3 & k);
};
